function [error, FileList] = CEAMakeInp(Pc, OF, eps, fuels, oxs)
...
%   array of OF ratios he wishes to analyse; eps is the nozzle area ratio;
%   fuels array of cells where the first row is the name of the reagents,
%   the second the weight fraction of each species, the temperature of the 
%   fuels, and if the reagents are 
...
for i = 1:length(Pc)
    ...
    % Sets nozzle area ratio for subsonic and supersonic cases
    fprintf(fid,'   subsonic,ae/at=%.4f,\n', eps);
    fprintf(fid,'   supersonic,ae/at=%.4f,\n', eps);
